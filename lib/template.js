...
class Template {
    ...
    async test(matcher, input = {}) {
        ...
        switch (type) {
            case 'lt':
            case 'lessthan':
                return this.getConditionFunc(condition)(ensureArray(eq || equal || number || numbers || NaN), (number) => {
            ...
            case 'base64':
                if (this.isString(input)) {
                    return this.getConditionFunc(condition)(ensureArray(b64 || base64 || b64s || base64s || ''), (b64) => {
